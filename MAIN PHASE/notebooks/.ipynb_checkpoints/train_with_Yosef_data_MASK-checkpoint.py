...
with open('../../INFERENCE/NuPoSe_Yosef_Data/ActivatingNuclesomal_TOT.pkl', 'rb') as f: 
...
dataset_test_act_obj = Nuc_Dataset(dataset_test_act_raw, max_length=67, rc_augmentation=True)
...
for fold, (train_idx, val_idx) in enumerate(skf.split(np.zeros(len(labels)), labels)):
    ...
    save_path = f"best_model_weights_99_8_percentile_fold{fold}_masked_YOSEF.pt"
