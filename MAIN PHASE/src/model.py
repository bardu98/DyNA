...
#         # NOTA: Ho aumentato max_len nel MyTransformer per evitare crash con sequenze lunghe
...
#         # IMPORTANTE: Ho aumentato max_len a 5000 per coprire qualsiasi lunghezza (tu usi 201)
#         # Se 73 era fisso per qualche motivo biologico specifico, rimettilo, ma con max_length=201 crasherebbe.
...
#     def forward(self, x):
#         # Taglia il PE alla lunghezza effettiva del batch corrente
